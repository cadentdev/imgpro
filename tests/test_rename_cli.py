...
def run_imagepro_rename(filepath, *args):
    ...
    """
    cmd = [sys.executable, 'imagepro.py', 'rename', str(filepath)] + list(args)
...
class TestRenameCommandBasics:
    ...
    def test_rename_command_exists(self):
        ...
        cmd = [sys.executable, 'imagepro.py', 'rename', '--help']
        result = subprocess.run(
            cmd,
            capture_output=True,
            text=True,
    ...
    def test_rename_requires_file_argument(self):
        ...
        cmd = [sys.executable, 'imagepro.py', 'rename']
        result = subprocess.run(
            cmd,
            capture_output=True,
            text=True,
    ...
    def test_rename_requires_action_flag(self, sample_square_image):
        ...
        exit_code, stdout, stderr = run_imagepro_rename(sample_square_image)
    ...
    def test_rename_file_not_found(self, temp_dir):
        ...
        exit_code, stdout, stderr = run_imagepro_rename(fake_file, '--ext')
    ...
    def test_rename_unsupported_file(self, sample_non_image_file):
        ...
        exit_code, stdout, stderr = run_imagepro_rename(sample_non_image_file, '--ext')
...
class TestRenameExtFlag:
    ...
    def test_ext_corrects_mismatched_extension(self, temp_dir):
        ...
        exit_code, stdout, stderr = run_imagepro_rename(fake_heic, '--ext')
    ...
    def test_ext_creates_copy_not_moves(self, temp_dir):
        ...
        run_imagepro_rename(original, '--ext')
    ...
    def test_ext_output_message(self, temp_dir):
        ...
        exit_code, stdout, stderr = run_imagepro_rename(original, '--ext')
...
class TestRenamePrefixExifDate:
    ...
    def test_prefix_exif_date_preserves_original(self, sample_image_with_exif):
        ...
        run_imagepro_rename(sample_image_with_exif, '--prefix-exif-date')
