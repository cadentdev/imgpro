...
def run_imagepro_info(filepath, *args):
    ...
    """
    cmd = [sys.executable, 'imagepro.py', 'info', str(filepath)] + list(args)
...
class TestInfoCommandBasics:
    ...
    def test_info_command_exists(self):
        ...
        cmd = [sys.executable, 'imagepro.py', 'info', '--help']
        result = subprocess.run(
            cmd,
            capture_output=True,
            text=True,
    ...
    def test_info_requires_file_argument(self):
        ...
        cmd = [sys.executable, 'imagepro.py', 'info']
        result = subprocess.run(
            cmd,
            capture_output=True,
            text=True,
    ...
    def test_info_file_not_found(self, temp_dir):
        ...
        exit_code, stdout, stderr = run_imagepro_info(fake_file)
    ...
    def test_info_unsupported_file_format(self, sample_non_image_file):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_non_image_file)
...
class TestInfoDefaultOutput:
    ...
    def test_info_default_output_square(self, sample_square_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_square_image)
    ...
    def test_info_default_output_landscape(self, sample_landscape_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_landscape_image)
    ...
    def test_info_default_output_portrait(self, sample_portrait_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_portrait_image)
    ...
    def test_info_default_shows_exif_presence(self, sample_image_with_exif):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_image_with_exif)
...
class TestInfoJsonOutput:
    ...
    def test_info_json_flag(self, sample_square_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_square_image, '--json')
    ...
    def test_info_json_correct_values_landscape(self, sample_landscape_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_landscape_image, '--json')
    ...
    def test_info_json_with_exif(self, sample_image_with_exif):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_image_with_exif, '--json')
    ...
    def test_info_json_without_exif(self, sample_image_no_exif):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_image_no_exif, '--json')
...
class TestInfoShortOutput:
    ...
    def test_info_short_flag(self, sample_square_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_square_image, '--short')
    ...
    def test_info_short_landscape(self, sample_landscape_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_landscape_image, '--short')
    ...
    def test_info_short_batch_compatible(self, sample_square_image, sample_landscape_image):
        ...
        exit_code1, stdout1, stderr1 = run_imagepro_info(sample_square_image, '--short')
        exit_code2, stdout2, stderr2 = run_imagepro_info(sample_landscape_image, '--short')
...
class TestInfoExifFlags:
    ...
    def test_info_exif_flag_shows_curated(self, sample_image_with_exif):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_image_with_exif, '--exif')
    ...
    def test_info_exif_all_flag(self, sample_image_with_exif):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_image_with_exif, '--exif-all')
    ...
    def test_info_exif_json_combination(self, sample_image_with_exif):
        ...
        exit_code, stdout, stderr = run_imagepro_info(
...
class TestInfoFormatSupport:
    ...
    def test_info_supports_png(self, sample_png_image):
        ...
        exit_code, stdout, stderr = run_imagepro_info(sample_png_image)
...
class TestInfoEdgeCases:
    ...
    def test_info_with_spaces_in_filename(self, temp_dir):
        ...
        exit_code, stdout, stderr = run_imagepro_info(filepath)
    ...
    def test_info_uncommon_aspect_ratio(self, temp_dir):
        ...
        exit_code, stdout, stderr = run_imagepro_info(filepath, '--json')
